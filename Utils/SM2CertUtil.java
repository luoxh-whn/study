...
public class SM2CertUtil {
    ...
    public static void main(String[] args) throws Exception {
        ...
        String TEST_PFX_PASSWD = "12345678";
        String TEST_PFX_FILENAME = "target/test.pfx";
        BCECPublicKey bcecPublicKey =  getPublicKeyFromPfx(InputStream2ByteArray("D:/123456.pfx"),password);
        System.out.println(bcecPublicKey.toString());
        BCECPrivateKey bcecPrivateKey = getPrivateKeyFromPfx(InputStream2ByteArray("D:/123456.pfx"),password);
