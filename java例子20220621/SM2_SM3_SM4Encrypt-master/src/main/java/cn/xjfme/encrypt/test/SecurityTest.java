...
public class SecurityTest {
    ...
    public void sm2enc() throws IOException {
        ...
        cipherText = "";
        
        System.out.println(cipherText);
        System.out.println("解密Test: ");
        prik = "d855cdde88941d79abf67bf7edb275464587b71920b213b7edc65e5540bc0193";
        plainText = new String( java.util.Base64.getDecoder().decode(SM2EncDecUtils.decrypt(Util.hexToByte(prik), Util.hexToByte(cipherText))));
        System.out.println("TEST="+plainText);
        System.out.println("****************************sm2enc***********************");
    }
    ...
    public void sm3() {
        ...
        System.out.println("msg1Hex="+Util.byteToHex(msg1));
        SM3Digest sm3 = new SM3Digest();
        sm3.update(msg1, 0, msg1.length);
        sm3.doFinal(md, 0);
        String s = new String(Hex.encode(md));
        System.out.println("mdHex="+s.toUpperCase());
    }
