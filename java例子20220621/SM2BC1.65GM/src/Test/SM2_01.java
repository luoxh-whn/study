...
public class SM2_01 {
	...
	public static void main(String[] args) throws UnsupportedEncodingException {
	    ...
	    publicKey = SM2_01.curve.decodePoint(Hex.decode(keyPair.getPubHexInSoft()));
	    
	    keyPair.setPublicKey(publicKey);
		System.out.println("kp_publickeyHex="+keyPair.getPubHexInSoft());
	    publicKey = SM2_01.curve.decodePoint(ByteUtils.fromHexString(keyPair.getPubHexInSoft()));
		...
		System.out.println("kp_publickeyHex="+keyPair.getPubHexInSoft());
        System.out.println("public_keyHex1="+Util.byteToHex(publicKey.getEncoded(false)));
		...
		byte[] data = sm02.encrypt("测试加密aaaaaaaaa3333**……%！aa罗雪华123aabb", publicKey);
		System.out.print("密文:");
		SM2_01.printHexString(data);
		System.out.println("解密后明文:" + sm02.decrypt(data, privateKey));
		
		System.out.print("私钥密码:");
		System.out.println("private_keyHex="+keyPair.getPriHexInSoft());
		
		//String dataHex ="";
		String dataHex ="";
		
		data = Util.hexToByte(dataHex);
		byte[] data1 = Util.hexStringToBytes(dataHex);
		
		System.out.println("data="+Util.encodeHexString(data));
		System.out.println("data1="+Util.encodeHexString(data1));
		System.out.println("data="+Util.byteToHex(data));
		System.out.println("data1="+Util.byteToHex(data1));
