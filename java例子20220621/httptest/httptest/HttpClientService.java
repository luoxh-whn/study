 ...
 public class HttpClientService {
     ...
     public static Object sendGet(String url, List<NameValuePair> nameValuePairList) throws Exception{
         ...
         try{
             ...
             if (SUCCESS_CODE == statusCode){
                 ...
                 log.info("HttpClientService-line: {}, errorMsg{}", 97, "GET请求失败！");
             }
         }catch (Exception e){
             log.info("HttpClientService-line: {}, Exception: {}", 100, e);
         } finally {
             response.close();
             client.close();
         }
     ...
     public static Object sendPost(String url, List<NameValuePair> nameValuePairList) throws Exception{
         ...
         try{
             ...
             if (SUCCESS_CODE == statusCode){
                 ...
                 log.info("HttpClientService-line: {}, errorMsg：{}", 146, "POST请求失败！");
             }
         }catch (Exception e){
             log.info("HttpClientService-line: {}, Exception：{}", 149, e);
         }finally {
             response.close();
             client.close();
         }
     ...
     public static List<NameValuePair> getParams(Object[] params, Object[] values){
         ...
         if (flag){
             ...
             log.info("HttpClientService-line: {}, errorMsg：{}", 197, "请求参数为空且参数长度不一致");
         }
         return null;
     }
 }